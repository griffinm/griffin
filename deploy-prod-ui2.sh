...
echo -e "${BLUE}=======================================${NC}"
echo -e "${BLUE}   Griffin UI2 Production Deployment   ${NC}"
echo -e "${BLUE}=======================================${NC}\n"

# Check if scripts exist
if [ ! -f "./build-prod-ui2.sh" ] || [ ! -f "./run-prod-ui2.sh" ]; then
...
echo "  Stop all:    ./stop-prod-ui2.sh"
echo "  Restart:     docker compose -f docker-compose.prod.ui2.yml restart"
